...
public class ItemConstants
{
    ...
    public static int getEffectItemID(final int itemId) {
        ...
        if (stats.containsKey("effectItemID")) {
            return ((Integer)stats.get("effectItemID")).intValue();
        }
        return 0;
    }
    ...
    public static class 伤害字型{
        private static Map<Integer, Integer> damageSkin = (Map<Integer, Integer>)new TreeMap();
        ...
        public static Map<Integer, Integer> getDamageSkin() {
            ...
            final Map<Integer, Integer> value = (Map<Integer, Integer>)new TreeMap();
        ...
        public static int getDamageSkinNumberByItem(final int itemid) {
            ...
            if (skin.containsKey(Integer.valueOf(itemid))) {
                return ((Integer)skin.get(Integer.valueOf(itemid))).intValue();
            }
            return -1;
        }
        ...
        public static Integer[] getDamageSkinsTradeBlock() {
            final Map<Integer, Integer> skin = getDamageSkin();
            final ArrayList<Integer> skins = (ArrayList<Integer>)new ArrayList();
            final Iterator<Integer> iterator = skin.keySet().iterator();
            while (iterator.hasNext()) {
                final int s = ((Integer)iterator.next()).intValue();
        ...
        static {
            damageSkin = (Map<Integer, Integer>)new TreeMap();
        }
    }
    ...
    public static class 卷轴
    {
        public static boolean canScroll(final int itemId) {
            return (itemId / 100000 != 19 && itemId / 100000 != 16) || 类型.心臟(itemId);
        }
    ...
    public static class 类型
    {
        ...
        public static boolean 脸饰(final int itemid) {
            return itemid / 10000 == 101;
        }
        
        public static boolean 眼饰(final int itemid) {
            return itemid / 10000 == 102;
        }
        
        public static boolean 耳环(final int itemid) {
        ...
        public static boolean 裤裙(final int itemid) {
        ...
        public static boolean 披风(final int itemid) {
        ...
        public static boolean 坠饰(final int itemid) {
            return itemid / 10000 == 112;
        }
        
        public static boolean 腰带(final int itemid) {
            return itemid / 10000 == 113;
        }
        
        public static boolean 勋章(final int itemid) {
            return itemid / 10000 == 114;
        }
        
        public static boolean 肩饰(final int itemid) {
        ...
        public static boolean 闪亮克魯(final int itemid) {
        ...
        public static boolean 机殼(final int itemid) {
            return itemid / 10000 == 164;
        }
        
        public static boolean 晶体管(final int itemid) {
            return itemid / 10000 == 165;
        }
        
        public static boolean 机器人(final int itemid) {
        ...
        public static boolean 宠物装备(final int itemid) {
            return itemid / 10000 >= 180 && itemid / 10000 <= 183;
        }
        
        public static boolean 骑宠(final int itemid) {
            return itemid / 10000 == 190 || itemid / 10000 == 193;
        }
        
        public static boolean 马鞍(final int itemid) {
            return itemid / 10000 == 191;
        }
        
        public static boolean 龙面具(final int itemid) {
            return itemid / 10000 == 194;
        }
        
        public static boolean 龙坠饰(final int itemid) {
            return itemid / 10000 == 195;
        }
        
        public static boolean 龙之翼(final int itemid) {
            return itemid / 10000 == 196;
        }
        
        public static boolean 龙尾巴(final int itemid) {
            return itemid / 10000 == 197;
        }
        
        public static boolean 飞鏢(final int itemid) {
            return itemid / 10000 == 207;
        }
        
        public static boolean 子弹(final int itemid) {
            return itemid / 10000 == 233;
        }
        
        public static boolean 宠物(final int id) {
            return id / 10000 == 500;
        }
        ...
        public static boolean 饰品(final int itemid) {
            return 脸饰(itemid) || 眼饰(itemid) || 耳环(itemid) || 戒指(itemid) || 坠饰(itemid) || 腰带(itemid) || 勋章(itemid) || 肩饰(itemid) || 口袋道具(itemid) || 胸章(itemid) || 能源(itemid) || 图騰(itemid);
        }
        ...
        public static boolean 机械(final int itemid) {
            return 引擎(itemid) || 手臂(itemid) || 腿(itemid) || 机殼(itemid) || 晶体管(itemid);
        }
        ...
        public static boolean 骑宠道具(final int itemid) {
        ...
        public static boolean 装饰(final int itemid) {
        ...
        public static boolean 友谊戒指(final int itemid) {
            switch (itemid) {
                case 1112800:
                case 1112801:
                case 1112802:
        ...
        public static boolean 恋人戒指(final int itemid) {
            switch (itemid) {
                case 1048000:
                case 1048001:
                case 1048002:
        ...
        public static boolean 结婚戒指(final int itemid) {
            switch (itemid) {
                case 1112300:
                case 1112301:
                case 1112302:
        ...
        public static boolean 城鎮传送卷轴(final int itemid) {
            return itemid >= 2030000 && itemid < 2040000;
        }
        
        public static boolean 普通升级卷轴(final int itemid) {
            return itemid >= 2040000 && itemid <= 2048100 && !阿斯旺卷轴(itemid);
        }
        
        public static boolean 阿斯旺卷轴(final int itemid) {
        ...
        public static boolean 附加潜能卷轴(final int itemid) {
            return itemid / 100 == 20483 && (itemid < 2048200 || itemid > 2048304);
        }
        
        public static boolean 白醫卷轴(final int itemid) {
            return itemid / 100 == 20490;
        }
        
        public static boolean 混沌卷轴(final int itemid) {
            return (itemid < 2049105 || itemid > 2049110) && (itemid / 100 == 20491 || itemid == 2040126);
        }
        
        public static boolean 乐观混沌卷轴(final int itemid) {
            if (!混沌卷轴(itemid)) {
                return false;
            }
            switch (itemid) {
        ...
        public static boolean 饰品卷轴(final int itemid) {
            return itemid / 100 == 20492;
        }
        
        public static boolean 装备强化卷轴(final int itemid) {
            return itemid / 100 == 20493;
        }
        
        public static boolean 铁鎚(final int itemid) {
            return itemid / 10000 == 247;
        }
        
        public static boolean 潜能卷轴(final int itemid) {
            return itemid / 100 == 20494 || itemid / 100 == 20497 || itemid == 5534000;
        }
        
        public static boolean 回真卷轴(final int itemid) {
            switch (itemid) {
                case 5064200:
                case 5064201: {
                    return true;
        ...
        public static boolean 幸运日卷轴(final int itemid) {
            switch (itemid) {
                case 5063100:
                case 5068000: {
                    return true;
        ...
        public static boolean 保护卷轴(final int itemid) {
            switch (itemid) {
                case 5063100:
                case 5064000:
                case 5064002:
        ...
        public static boolean 安全卷轴(final int itemid) {
            switch (itemid) {
                case 5064100:
                case 5064101:
                case 5068100: {
        ...
        public static boolean 卷轴保护卡(final int itemid) {
            switch (itemid) {
                case 5064300:
                case 5064301:
                case 5068200: {
        ...
        public static boolean 灵魂卷轴_附魔器(final int itemid) {
            return itemid / 1000 == 2590;
        }
        
        public static boolean 灵魂宝珠(final int itemid) {
            return itemid / 1000 == 2591;
        }
        
        public static boolean TMS特殊卷轴(final int itemid) {
