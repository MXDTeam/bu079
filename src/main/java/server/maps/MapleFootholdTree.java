...
public class MapleFootholdTree
{
    ...
    public MapleFootholdTree(final Point p1, final Point p2) {
        ...
        this.sw = null;
        this.se = null;
        this.footholds = (List<MapleFoothold>)new LinkedList();
        this.depth = 0;
        this.p1 = p1;
        this.p2 = p2;
    ...
    private final List<MapleFoothold> getRelevants(final Point p) {
        return this.getRelevants(p, (List<MapleFoothold>)new LinkedList());
    }
    ...
    public final MapleFoothold findBelow(final Point p) {
        ...
        final List<MapleFoothold> xMatches = (List<MapleFoothold>)new LinkedList();
