...
public class MapleSnowball extends MapleEvent
{
    ...
    public static class MapleSnowballs
    {
        ...
        public static final void hitSnowball(final MapleCharacter chr) {
            ...
            final MapleSnowball sb = (MapleSnowball)chr.getClient().getChannelServer().getEvent(MapleEventType.滚雪球);
                ...
                if (!snowman) {
                    ...
                    if (damage == 0) {
                        ...
                        if (ball.getPosition() == 255 || ball.getPosition() == 511 || ball.getPosition() == 767) {
                            ...
                            chr.getMap().broadcastMessage(MaplePacketCreator.serverNotice(6, "[恭喜] " + ((team == 0) ? "蓝队" : "红队") + " 贏得胜利!"));
