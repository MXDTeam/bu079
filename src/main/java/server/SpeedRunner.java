...
public class SpeedRunner
{
    ...
    private SpeedRunner() {
        this.speedRunData = new EnumMap(SpeedRunType.class);
    }
    ...
    public final void addSpeedRunData(final SpeedRunType type, final Pair<StringBuilder, Map<Integer, String>> mib) {
        this.speedRunData.put(type, new Pair(((StringBuilder)mib.getLeft()).toString(), mib.getRight()));
    }
    ...
    public final void loadSpeedRunData(final SpeedRunType type) throws SQLException {
        try (final Connection con = (Connection)DBConPool.getInstance().getDataSource().getConnection();
            ...
            final Map<Integer, String> rett = (Map<Integer, String>)new LinkedHashMap();
            boolean changed;
