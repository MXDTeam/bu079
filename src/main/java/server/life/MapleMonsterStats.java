...
public class MapleMonsterStats
{
    ...
    public MapleMonsterStats() {
        this.resistance = (Map<Element, ElementalEffectiveness>)new HashMap();
        this.revives = (List<Integer>)new ArrayList();
        this.skills = (List<Pair<Integer, Integer>>)new ArrayList();
    }
