...
public class MapleFamilyCharacter implements Serializable
{
    ...
    public MapleFamilyCharacter(final MapleCharacter c, final int fid, final int sid, final int j1, final int j2) {
        this.channel = -1;
        this.pedigree = (List<Integer>)new ArrayList();
        this.descendants = 0;
        this.name = c.getName();
    ...
    public List<MapleFamilyCharacter> getAllJuniors(final MapleFamily fam) {
        final List<MapleFamilyCharacter> ret = (List<MapleFamilyCharacter>)new ArrayList();
        ret.add(this);
        if (this.junior1 > 0) {
    ...
    public void resetPedigree(final MapleFamily fam) {
        (this.pedigree = (List<Integer>)new ArrayList()).add(Integer.valueOf(this.id));
        if (this.seniorid > 0) {
