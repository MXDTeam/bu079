...
public class CharacterTransfer implements Externalizable
{
    ...
    public long limitBreak;
    public int reinNumber;
    
    public CharacterTransfer() {
        this.mbook = (Map<Integer, Integer>)new LinkedHashMap();
        this.keymap = (Map<Integer, Pair<Byte, Integer>>)new LinkedHashMap();
        this.finishedAchievements = (List<Integer>)new ArrayList();
        this.famedcharacters = (List<Integer>)new ArrayList();
        this.buddies = (Map<BuddyEntry, Boolean>)new LinkedHashMap();
        this.Quest = (Map<Integer, Object>)new LinkedHashMap();
        this.InfoQuest = (Map<Integer, String>)new LinkedHashMap();
        this.Skills = (Map<Integer, SkillEntry>)new LinkedHashMap();
    }
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.GM吸怪讯息开关 = chr.get_control_吸怪讯息();
        ...
        this.reinNumber = chr.getReinNumber();
        this.vip = chr.getVip();
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.writeBoolean(this.GM吸怪讯息开关);
        ...
        out.writeLong(this.limitBreak);
        out.writeInt(this.reinNumber);
        for (int i = 0; i < this.remainingSp.length; ++i) {
        ...
        for (final Entry<BuddyEntry, Boolean> qs2 : this.buddies.entrySet()) {
            ...
            out.writeBoolean(((Boolean)qs2.getValue()).booleanValue());
        ...
        for (final Entry<Integer, Object> qs3 : this.Quest.entrySet()) {
            out.writeInt(((Integer)qs3.getKey()).intValue());
        ...
        for (final Entry<Integer, String> qs4 : this.InfoQuest.entrySet()) {
            out.writeInt(((Integer)qs4.getKey()).intValue());
        ...
        for (final Entry<Integer, Pair<Byte, Integer>> qs5 : this.keymap.entrySet()) {
            out.writeInt(((Integer)qs5.getKey()).intValue());
            out.writeByte((int)((Byte)((Pair<Byte, Integer>)qs5.getValue()).left).byteValue());
            out.writeInt(((Integer)((Pair<Byte, Integer>)qs5.getValue()).right).intValue());
        }
