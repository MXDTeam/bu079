...
public class AccountStorage
{
    ...
    public final List<MapleClient> getAllClientsThreadSafe() {
        final List<MapleClient> ret = (List<MapleClient>)new ArrayList();
    ...
    public final void deregisterAccount(final MapleClient c) {
        this.writeLock.lock();
        try {
            final List<Integer> clients = (List<Integer>)new ArrayList();
            ...
            while (iterator2.hasNext()) {
                final int id = ((Integer)iterator2.next()).intValue();
    ...
    public final int pendingClientSize(final int world) {
        final Map<Integer, MapleClient> clients = (Map<Integer, MapleClient>)new HashMap();
