...
public class BeanGame
{
    ...
    public static final void BeansGameAction(final LittleEndianAccessor slea, final MapleClient c) {
        ...
        final int 海洋帽子机率 = Beans.get海洋帽子机率();
        final int 力度搞假 = Beans.get力度搞假();
        final int 豆豆奖励范围 = Beans.get豆豆奖励范围();
        final String[] 黄金狗机率 = Beans.get黄金狗机率();
        final String[] 大白怪 = Beans.get大白怪();
        final String[] 小白怪 = Beans.get小白怪();
        final String[] 紫色怪 = Beans.get紫色怪();
        final String[] 粉色怪 = Beans.get粉色怪();
        final String[] 飞侠 = Beans.get飞俠();
        final String[] 海盗 = Beans.get海盜();
        final String[] 魔法师 = Beans.get魔法师();
        final String[] 战士 = Beans.get战士();
        final String[] 弓箭手 = Beans.get弓箭手();
        final String[] 女皇 = Beans.get女皇();
        final String[] 白怪奖励 = Beans.get白怪奖励();
        final String[] 色怪奖励 = Beans.get色怪奖励();
        final String[] 五职业奖励 = Beans.get五职业奖励();
        final String[] 女皇奖励 = Beans.get女皇奖励();
        final MapleCharacter chr = c.getPlayer();
        final List<MapleBeans> beansInfo = (List<MapleBeans>)new ArrayList();
