...
public class PlayerStorage
{
    ...
    public final List<MapleCharacter> getAllCharactersThreadSafe() {
        final List<MapleCharacter> ret = (List<MapleCharacter>)new ArrayList();
        try {
    ...
    public final int pendingCharacterSize(final int world) {
        final Map<Integer, MapleCharacter> chars = (Map<Integer, MapleCharacter>)new HashMap();
    ...
    public final List<CheaterData> getCheaters() {
        final List<CheaterData> cheaters = (List<CheaterData>)new ArrayList();
        this.readLock.lock();
        try {
            for (final MapleCharacter chr : this.idToChar.values()) {
    ...
    public class PersistingTask implements Runnable
    {
        ...
        public void run() {
            ...
            try {
                ...
                final Iterator<Entry<Integer, CharacterTransfer>> itr = PlayerStorage.this.PendingCharacter.entrySet().iterator();
                while (itr.hasNext()) {
