...
public class MapleDataTool
{
    ...
    public static int getInt(final MapleData data, final int def) {
        ...
        if (data.getType() == MapleDataType.SHORT) {
            return Integer.valueOf((int)((Short)data.getData()).shortValue()).intValue();
        }
        return ((Integer)data.getData()).intValue();
    }
    ...
    public static long getLongConvert(final MapleData data) {
        if (data.getType() == MapleDataType.STRING) {
    ...
    public static long getLong(final String path, final MapleData data) {
