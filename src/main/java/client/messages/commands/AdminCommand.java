...
public class AdminCommand
{
    ...
    public static class 临时npc extends NPC
    {
    }
    
    public static class 永久npc extends PNPC
    {
    }
    ...
    public static class 无敌 extends GodMode
    {
        @Override
        public String getMessage() {
            return new StringBuilder().append("!无敌 - 无敌开启").toString();
        }
    }
    ...
    public static class GodMode extends CommandExecute
    {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!godmode  - 无敌关闭").toString();
        }
    }
    ...
    public static class GainCash extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            final String msg = "[GM 密语] GM " + c.getPlayer().getName() + " 给了 " + player.getName() + " Gash点数 " + amount + "点";
    ...
    public static class 给抵用 extends GainMaplePoint
    {
        @Override
        public String getMessage() {
            return new StringBuilder().append("!给抵用 <数量> <玩家> - 取得抵用").toString();
        }
    }
    ...
    public static class GainMaplePoint extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            final String msg = "[GM 密语] GM " + c.getPlayer().getName() + " 给了 " + player.getName() + " 抵用 " + amount + "点";
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!gainmaplepoint <数量> <玩家> - 取得抵用").toString();
        }
    }
    ...
    public static class CloneMe extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (splitted.length > 1) {
                stopMoving = splitted[1].equals("true");
            }
            c.getPlayer().cloneLook(stopMoving);
            return true;
        }
    ...
    public static class DisposeClones extends CommandExecute
    {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!disposeclones - 摧毀克龙体").toString();
        }
    }
    ...
    public static class Spawn extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            try {
                ...
                c.getPlayer().dropMessage(5, "错误1: " + e.getMessage());
                return true;
            }
            long newhp;
            if (hp != null) {
            ...
            if (GameConstants.isPet(itemId)) {
                ...
                if (name != null) {
                    ...
                    if (ch > 0) {
                        ...
                        c.getPlayer().dropMessage("玩家: [" + name + "] 不在线上写");
                    }
                }
                else {
    ...
    public static class ProDrop extends CommandExecute
    {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!ProDrop <物品代码> (<力量> <敏捷> <智力> <幸运> <HP> <MP> <物攻> <魔攻> <物防> <魔防> <武器+x> <命中> <回避> <移动> <跳跃> <冲捲数> <天数>)").toString();
        }
    }
    ...
    public static class 给点数 extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            try {
                ...
                switch (s) {
                    ...
                    default: {
                        error = "输入的文字不是[点数]和[抵用] 而是[" + input + "]";
                        break;
                    }
                }
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!给点数 点数/抵用 玩家名称 数量").toString();
        }
    }
    ...
    public static class CashEveryone extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (splitted.length > 2) {
                ...
                for (final ChannelServer cserv : ChannelServer.getAllInstances()) {
                    for (final MapleCharacter mch : cserv.getPlayerStorage().getAllCharacters()) {
                        mch.modifyCSPoints(type, quantity, true);
                        ++ret;
                    }
                }
                ...
                c.getPlayer().dropMessage(6, "命令使用成功，当前共有: " + ret + " 个玩家获得: " + quantity + " 点的" + ((type == 1) ? "点券 " : " 抵用 ") + " 共计: " + ret * quantity);
            }
            else {
                c.getPlayer().dropMessage(6, "用法: !给所有人点数 [点数类型1-2] [点数数量] 1是点券.2是抵用");
            }
    ...
    public static class 给地图人红利 extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (splitted.length > 1) {
                ...
                c.getPlayer().dropMessage(6, "命令使用成功，当前共有: " + ret + " 个玩家获得: " + quantity + " 红利" + " 共计: " + ret * quantity);
            }
            else {
