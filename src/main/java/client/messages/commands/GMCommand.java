...
public class GMCommand
{
    ...
    public static class 刷新地图1 extends UpdateMap
    {
    }
    ...
    public static class 查看当前地图信息 extends CommandExecute
    {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!查看当前地图信息 - 查看当前地图信息").toString();
        }
    }
    
    public static class spmap extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            for (int i = 0; i <= 990001101; ++i) {
                if (c.getChannelServer().getMapFactory().getMap(i) != null) {
                    final StringBuilder sb = new StringBuilder();
                    sb.append(c.getChannelServer().getMapFactory().getMap(i).getFirstUserEnter());
                    sb.append("\r\n");
                    FileoutputUtil.logToFile("logs/地图事件1.txt", sb.toString());
                    final StringBuilder sb2 = new StringBuilder();
                    sb2.append(c.getChannelServer().getMapFactory().getMap(i).getonUserEnter());
                    sb2.append("\r\n");
                    FileoutputUtil.logToFile("logs/地图事件2.txt", sb2.toString());
                }
            }
            c.getPlayer().dropMessage(6, "添加完毕");
            return true;
        }
        
        @Override
        public String getMessage() {
            return new StringBuilder().append("!spmap").toString();
        }
    }
    ...
    public static class 修改人气商品 extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (input < 1 || input > 5) {
                c.getPlayer().dropMessage("数字只能输入1~5之间写");
                return true;
            }
    ...
    public static class 添加aclog extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (playerid == -1) {
                c.getPlayer().dropMessage(6, "玩家[" + playername + "]不存在于资料库內。");
                return true;
            }
    ...
    public static class 推文 extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (victim != null) {
                ...
                c.getPlayer().dropMessage(6, "推文玩家[" + playername + "] 300Gash 500抵用发放成功。");
            }
            else {
                c.getPlayer().dropMessage(6, "玩家[" + playername + "]不存在于资料库內。");
            }
    ...
    public static class GoTo extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (splitted.length < 2) {
                ...
                final MapleMap target = c.getChannelServer().getMapFactory().getMap(((Integer)GoTo.gotomaps.get(splitted[1])).intValue());
        ...
        static {
            (gotomaps = new HashMap()).put("gmmap", Integer.valueOf(180000000));
            ...
            gotomaps.put("lithharbour", Integer.valueOf(104000000));
            gotomaps.put("sleepywood", Integer.valueOf(105040300));
            gotomaps.put("florina", Integer.valueOf(110000000));
            ...
            gotomaps.put("mushmom", Integer.valueOf(100000005));
            ...
            gotomaps.put("taiwan", Integer.valueOf(740000000));
            gotomaps.put("thailand", Integer.valueOf(500000000));
            gotomaps.put("erev", Integer.valueOf(130000000));
            gotomaps.put("ellinforest", Integer.valueOf(300000000));
            ...
            gotomaps.put("peachblossom", Integer.valueOf(700000000));
            ...
            gotomaps.put("cashmap", Integer.valueOf(741010200));
    ...
    public static class 重载捉鬼任务 extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            活动捉鬼任务.启动捉鬼任务();
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!重载捉鬼任务 - 重载捉鬼任务").toString();
        }
    }
    ...
    public static class ShutdownTime extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            c.getPlayer().dropMessage(6, "服务器将在 " + this.minutesLeft + "分钟后关闭. 请盡速关闭精灵商人 并下线.");
            if (ShutdownTime.ts == null && (ShutdownTime.t == null || !ShutdownTime.t.isAlive())) {
                ...
                ShutdownTime.ts = EventTimer.getInstance().register((Runnable)new Runnable() {
                    @Override
                    public void run() {
                        if (ShutdownTime.this.minutesLeft > 0 && ShutdownTime.this.minutesLeft <= 11 && !World.isShutDown) {
                            World.isShutDown = true;
                            c.getPlayer().dropMessage(6, "已经限制玩家玩家所有行动。");
                        }
                        else if (ShutdownTime.this.minutesLeft == 0) {
                        ...
                        for (final ChannelServer cs : ChannelServer.getAllInstances()) {
                            cs.setServerMessage("服务器将于 " + ShutdownTime.this.minutesLeft + " 分钟后关机");
                        }
    ...
    public static class ReloadFishing extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            c.getPlayer().dropMessage(6, "釣鱼已重置完成");
            return true;
        }
        
        @Override
        public String getMessage() {
            return new StringBuilder().append("!reloadFishing - 重新载入釣鱼奖励").toString();
        }
    }
    ...
    public static class ReloadLife extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            c.getPlayer().dropMessage("自定物件重新载入完成 共重新载入:" + MapleMapFactory.loadCustomLife(true, c.getPlayer().getMap()));
            return true;
        }
        
        @Override
        public String getMessage() {
            return new StringBuilder().append("!ReloadLife - 重新载入自定NPC/怪物").toString();
        }
    }
    ...
    public static class AP extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            final List<Pair<MapleStat, Integer>> statupdate = (List<Pair<MapleStat, Integer>>)new ArrayList();
    ...
    public static class 关鍵时刻 extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (关鍵时刻.ts != null) {
                关鍵时刻.ts.cancel(false);
                c.getPlayer().dropMessage(0, "原定的关鍵时刻已取消");
            }
            int minutesLeft;
            try {
            ...
            if (minutesLeft > 0) {
                关鍵时刻.ts = EventTimer.getInstance().schedule((Runnable)new Runnable() {
                    @Override
                    public void run() {
                        for (final ChannelServer cserv : ChannelServer.getAllInstances()) {
                        ...
                        Broadcast.broadcastMessage(MaplePacketCreator.serverNotice(6, "关鍵时刻开放囉，沒有30等以上的玩家是得不到的。"));
                        关鍵时刻.ts.cancel(false);
                        关鍵时刻.ts = null;
                    }
                }, (long)minutesLeft);
                c.getPlayer().dropMessage(0, "关鍵时刻预定已完成");
            }
            else {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!关鍵时刻 <时间:分钟> - 关鍵时刻").toString();
        }
    ...
    public static class UnlockInv extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            final Map<IItem, MapleInventoryType> eqs = (Map<IItem, MapleInventoryType>)new ArrayMap();
            boolean add = false;
    ...
    public static class Letter extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            final List<Integer> chars = (List<Integer>)new ArrayList();
            ...
            for (final Integer j : chars) {
                if (j.intValue() == -1) {
                ...
                else if (j.intValue() < 200) {
                    final int val = start + j.intValue() - 65;
                    ...
                    if (j.intValue() < 200 || j.intValue() > 300) {
                        continue;
                    }
                    final int val = nstart + j.intValue() - 48 - 200;
                    final Item item = new Item(val, (byte)0, (short)1);
                    c.getPlayer().getMap().spawnItemDrop((MapleMapObject)c.getPlayer(), c.getPlayer(), (IItem)item, new Point(dStart, c.getPlayer().getPosition().y), false, false);
                    dStart += 32;
                }
    ...
    public static class autoreg extends CommandExecute
    {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!autoreg  - 自动注冊开关").toString();
        }
    }
    ...
    public static class 丟弃物品讯息 extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            WorldConstants.DropItem = !WorldConstants.DropItem;
            c.getPlayer().dropMessage(0, "[丟弃物品讯息] " + (WorldConstants.DropItem ? "开启" : "关闭"));
            System.out.println("[丟弃物品讯息] " + (WorldConstants.DropItem ? "开启" : "关闭"));
            return true;
        }
        
        @Override
        public String getMessage() {
            return new StringBuilder().append("!丟弃物品讯息  - 丟弃物品讯息").toString();
        }
    }
    ...
    public static class log extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (splitted[1].contains((CharSequence)"开") && splitted[1].contains((CharSequence)"关")) {
                c.getPlayer().dropMessage("请問这位管理员到底是要开还是关呢?");
                return true;
            }
    ...
    public static class RemoveItemOff extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            try (final Connection con = (Connection)DBConPool.getInstance().getDataSource().getConnection()) {
                ...
                int id = 0;
                int quantity = 0;
                final List<Long> inventoryitemid = (List<Long>)new LinkedList();
    ...
    public static class 召唤怪物 extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (hp != null) {
                ...
                newhp = (long)((double)onemob.getMobMaxHp() * (php.doubleValue() / 100.0));
            }
            else {
                newhp = onemob.getMobMaxHp();
            }
            if (mp != null) {
                final int newmp = mp.intValue();
            }
            else if (pmp != null) {
                final int newmp = (int)((double)onemob.getMobMaxMp() * (pmp.doubleValue() / 100.0));
            }
            else {
            ...
            if (exp != null) {
                ...
                newexp = (int)((double)onemob.getMobExp() * (pexp.doubleValue() / 100.0));
            }
            else {
    ...
    public static class 处理洗道具 extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (OnlyIDList.isEmpty()) {
                c.getPlayer().dropMessage("目前沒有复制装备的资料，请暑促互 !查询洗道具 来获得资料");
                return true;
            }
            try {
                final ListIterator<Triple<Integer, Long, Long>> OnlyId = OnlyIDList.listIterator();
                while (OnlyId.hasNext()) {
                    final Triple<Integer, Long, Long> Only = OnlyId.next();
                    final int chr = ((Integer)Only.getLeft()).intValue();
                    final long invetoryitemid = ((Long)Only.getMid()).longValue();
                    final long equiponlyid = ((Long)Only.getRight()).longValue();
        ...
        public void HandleOffline(final MapleClient c, final int chr, final long inventoryitemid, final long equiponlyid) {
            try (final Connection con = (Connection)DBConPool.getInstance().getDataSource().getConnection()) {
                ...
                final String msgtext = "玩家ID: " + chr + " 在玩家道具中发现复制装备[" + itemname + "]已经将其刪除。";
                Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, "[GM密语] " + msgtext));
                FileoutputUtil.logToFile("Hack/复制装备_已刪除.txt", msgtext + " 道具唯一ID: " + equiponlyid);
                con.close();
            }
            catch (Exception ex) {
    ...
    public static class 添加危险账号 extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (splitted.length < 2) {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!添加危险账号 <角色名字> - 添加危险账号").toString();
        }
    }
    ...
    public static class 头頂公告 extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (splitted.length > 1) {
                ...
                c.getPlayer().dropMessage(0, "[头頂公告] " + sb.toString());
                System.out.println("[头頂公告] " + sb.toString());
                return true;
            }
            return false;
        }
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!头頂公告  - 头頂公告").toString();
        }
    }
    ...
    public static class Killalldrops extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            for (final MapleMapObject monstermo : map.getMapObjectsInRange(c.getPlayer().getPosition(), range, Arrays.asList(MapleMapObjectType.MONSTER))) {
                ...
                if (!mob.getStats().isBoss() || c.getPlayer().isGM()) {
                    ...
                    mob.giveExpToCharacter(c.getPlayer(), mob.getMobExp(), false, 0, (byte)0, (byte)0, (byte)0, 0);
                }
            }
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!Killalldrops  -杀死怪物掉落物品").toString();
        }
    }
    ...
    public static class 复活 extends CommandExecute
    {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!fh/复活  -复活").toString();
        }
    }
    ...
    public static class 公告 extends CommandExecute
    {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!公告  -发一个公告提示").toString();
        }
    }
    
    public static class 启动蘑菇活动 extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (!Mushplotact.getStartState()) {
                Mushplotact.changeInitialization(true, System.currentTimeMillis());
                Mushplotact.setMushroomStage("蘑菇剧情阶段", 1);
                c.getPlayer().dropMessage(6, "蘑菇rpg线程正在启动中");
                for (final ChannelServer cserv1 : ChannelServer.getAllInstances()) {
                    for (final MapleCharacter mch : cserv1.getPlayerStorage().getAllCharacters()) {
                        mch.startMapEffect("【大型活动】:拯救蘑菇王国的小公举!即将在" + Mushplotact.getOneTimeCd() + "秒后启动,大家通过拍卖入场吧", 5121009);
                    }
                }
                return true;
            }
            c.getPlayer().dropMessage(6, "蘑菇rpg线程已经启动");
            return true;
        }
        
        @Override
        public String getMessage() {
            return new StringBuilder().append("!启动蘑菇活动  - 启动蘑菇活动").toString();
        }
    }
    
    public static class 关闭蘑菇活动 extends CommandExecute
    {
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (Mushplotact.getStartState()) {
                Mushplotact.changeInitialization(false, 0L);
                ...
                Mushplotact.setMushroomStage("蘑菇剧情阶段", 1);
                c.getPlayer().dropMessage(6, "蘑菇rpg线程正在关闭中");
                for (final ChannelServer cserv1 : ChannelServer.getAllInstances()) {
                    for (final MapleCharacter mch : cserv1.getPlayerStorage().getAllCharacters()) {
                        mch.startMapEffect("【大型活动】:拯救蘑菇王国的小公举!被管理员强制关闭!", 5121009);
                    }
                }
                return true;
            }
            c.getPlayer().dropMessage(6, "蘑菇rpg线程已经关闭");
            return true;
        }
